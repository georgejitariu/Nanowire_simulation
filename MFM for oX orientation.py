...
for n in range(0, 11, 1):
    m_field = df.Field.fromfile(r'F:\Anaconda\envs\mfm\samples_j/'+str(n)+'.ovf')
    field_rotator = df.FieldRotator(m_field)
    new_field=m_field
    new_field.mesh.region=df.Region(p1=(0,0,-1.6e-07),p2=(1.28e-06,1.6e-07,0))
    ...
    phase.plane(z=3e-8).mpl.scalar(figsize=(30,2) ,cmap='afmhot', colorbar_label='Phase shift (radians)')
